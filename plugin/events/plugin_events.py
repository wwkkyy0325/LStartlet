...
class PluginLoadedEvent(BaseEvent):
    ...
    def __init__(self, plugin_id: str, plugin_name: str, version: str, metadata: Optional[Dict[str, Any]] = None):
...
class PluginInitializedEvent(BaseEvent):
    ...
    def __init__(self, plugin_id: str, plugin_name: str, success: bool, error_message: Optional[str] = None):
        super().__init__(self.EVENT_TYPE)
        self.plugin_id = plugin_id
        self.plugin_name = plugin_name
