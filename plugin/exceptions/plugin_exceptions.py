...
class PluginError(Exception):
    ...
    def __init__(self, plugin_id: str, message: str, inner_exception: Optional[Exception] = None):
...
class PluginDependencyError(PluginError):
    ...
    def __init__(self, plugin_id: str, dependency_name: str, required_version: str, message: str):
        super().__init__(plugin_id, f"依赖 {dependency_name} (要求版本: {required_version}) 错误: {message}")
