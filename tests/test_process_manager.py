...
class TestProcessManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_global_process_manager_class.return_value = (
            self.mock_global_process_manager
        )
    ...
    def test_start_stop(self):
        ...
        # 验证事件总线调用
        self.assertEqual(
            self.mock_event_bus.publish.call_count, 2
        )  # ProcessCreatedEvent + ProcessStartedEvent
