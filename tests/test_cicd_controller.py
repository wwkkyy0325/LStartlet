...
class TestCICDController(unittest.TestCase):
    ...
    def test_run_pipeline_success(
        ...
        mock_builder.return_value.get_build_artifacts.return_value = [
            "./build/artifact.zip"
        ]
        ...
        mock_version_controller.return_value.create_tag.assert_called_once_with(
            "v1.0.0", "Auto-build v1.0.0"
        )
