...
import unittest
from core.di import ServiceContainer, ServiceLifetime, ServiceResolutionError, ServiceRegistrationError
...
class TestServiceContainer(unittest.TestCase):
    ...
    def test_register_instance_singleton(self):
        ...
        container.register(TestService, instance=instance, lifetime=ServiceLifetime.SINGLETON)
