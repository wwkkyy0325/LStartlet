...
from LStartlet.core.version_control import VersionController
...
if TYPE_CHECKING:
    from LStartlet.core.system.config_manager import SystemConfigManager
...
Timestamp: {time.strftime('%Y-%m-%d %H:%M:%S')}
    ...
    def generate_pipeline_report(
        ...
        if self.dependency_installer:
            try:
                from LStartlet.core.version_control.dependency_resolver import (
                    DependencyResolver,
                )
