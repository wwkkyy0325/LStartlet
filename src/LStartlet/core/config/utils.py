...
from LStartlet.core.path import ensure_directory_exists
from LStartlet.core.decorators import with_error_handling, monitor_metrics  # type: ignore
...
class ConfigUtils:
    ...
    def create_config_backup(
        config_data: Dict[str, Any], backup_dir: str, max_backups: int = 5
    ) -> bool:
        """
        创建配置备份
