...
class CommandResult:
    """命令执行结果"""
    def __init__(self, is_success: bool, message: str = "", data: Optional[Dict[str, Any]] = None, 
    ...
    @classmethod
    def success(cls, message: str = "Command executed successfully", data: Optional[Dict[str, Any]] = None) -> 'CommandResult':
        return cls(is_success=True, message=message, data=data)
    
    @classmethod
    def failure(cls, message: str, error: Optional[Exception] = None) -> 'CommandResult':
