...
class UIMountAreaEvent(UIComponentEvent):
    ...
    def __init__(self, component_id: str, area_action: str, area_data: Dict[str, Any]):
        super().__init__(self.EVENT_TYPE, component_id, {"action": area_action, "data": area_data})
...
class RenderProcessReadyEvent(BaseEvent):
    ...
    def __init__(self, process_id: str, custom_ui_callback: Optional[Callable[[], None]] = None):
        """
        初始化渲染进程准备就绪事件
